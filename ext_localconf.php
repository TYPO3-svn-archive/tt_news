...
# extends the wizard_add script to set default values in new created records
...
#$GLOBALS ['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_userauthgroup.php']['calcPerms'][] = 'EXT:tt_news/class.tx_ttnews_userauthgroup.php:tx_ttnews_userauthgroup->calcPerms';
